    ...
    <Container className="py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">Last updated: March 06, 2025</p>
        </div>
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <p>
                ...
                or &quot;Our&quot; in this Agreement) refers to Neura.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Neura, accessible from{" "}
                <a
                  href="https://neura-mind.vercel.app/"
                  rel="noreferrer external nofollow noopener"
                  target="_blank"
                  className="text-primary hover:underline"
                >
                  https://neura-mind.vercel.app/
                </a>
              </p>
            </li>
            <li>
          ...
          <h4 className="text-lg font-medium mt-4">Tracking Technologies and Cookies</h4>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6">Disclosure of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-medium mt-6">Security of Your Personal Data</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              By email:{" "}
              <a href="mailto:jayan110105@gmail.com" className="text-primary hover:underline">
